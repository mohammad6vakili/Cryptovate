...
const ViewAll = ({ theme }: { theme: string }) => {
  const [section, setSection] = React.useState("Total Collections");
  ...
  return (
    <>
      <div className="viewAll-wrapper">
        ...
        <Typography label="Explore Our Collections" type="heading" />
          ...
          <div className="sectionSelector">
            <button
              className={`sectionPart ${
                section === "Total Collections" ? "purple" : ""
              }`}
              onClick={() => setSection("Total Collections")}
            >
              Total Collections
            </button>
            <button
