...
const CollectionsSelected = ({ theme }: { theme: string }) => {
  ...
  const cardData = <><div className="firstCardContainer">
                    <Card
                      imgSrc= { normalImage }
                      onClick={() => navigate("/selectedNFT/collections")}
                      size="large"
                      pill={{
                        label: "Lorem Ipsum",
  ...
  return (
    <>
      <div className="selected-wrapper">
        ...
        <section className="collectionName-wrapper">
          ...
          <Typography label="Collections Name" type="heading" />
